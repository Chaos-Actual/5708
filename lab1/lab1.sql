...
Find the region with smallest population.
Do not use MIN. You will need SUM to compute region totals. You need to return both region and its population. (Hint: use self join)
