...
--4
INSERT INTO MYCITY (ID, AREA, PERIMETER, DESCRIPTION(CITY_NAME, CNTRY_NAME, STATUS, POP_RANK, POP_CLASS), LOCATION)
SELECT ID, AREA, PERIMETER, CITY_NAME, CNTRY_NAME, STATUS, POP_RANK, LOCATION FROM CITY;
 /
DECLARE CTY CITY_DESC;
BEGIN
INSERT INTO MYCITY (ID, AREA, PERIMETER, DESCRIPTION, LOCATION)
SELECT ID, AREA, PERIMETER, CTY(CITY_NAME, CNTRY_NAME, STATUS, POP_RANK, POP_CLASS), LOCATION FROM CITY;
END;
/
